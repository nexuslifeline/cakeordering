...
INSERT INTO `cake_orders` (`cake_order_id`, `cake_structure`, `suggestion_box`, `cost`, `customer_id`, `estimated_pickedup`, `status`, `date_ordered`, `date_finalized`, `finalized_by`, `is_finalized`, `date_pickedup`, `is_pickedup`, `is_active`, `is_deleted`) VALUES
(1, 'v', 'v', '0.0000', 1, '0000-00-00', 'pending', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 0, '0000-00-00', 0, 1, 0);
...
(1, 'customer2', 'customer2', 'customer2', 'customer2', 'customer2', '2017-08-16', '1', '1', 'customer2', 'customer2', '80dae43ddfcfbd7a5e75b83260eab8fd35fd6778', 'http://localhost:8012/cakeordering/backend/assets/images/cust/5980fb5ac7fc0.png', 1, 0);
...
INSERT INTO `payments` (`payment_id`, `or_no`, `date_paid`, `customer_id`, `cake_order_id`, `notes`, `is_active`, `is_deleted`) VALUES
(1, '1', '0000-00-00', 1, 0, '1', 1, 0);
...
--
ALTER TABLE `cake_orders`
  MODIFY `cake_order_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
