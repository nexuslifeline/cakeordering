  $(document).ready(function() {
      ...
      var initializeControls = function() {
          oTable = $('#list').DataTable({
              "dom": '<"toolbar">frtip',
              "bLengthChange": false,
              "ajax": http + "/Categories/transaction/list",
              "columns": [
          ...
          var createToolBarButton = function() {
              var _btnNew = '<button class="btn btn-info"  id="btn_new" data-toggle="modal" data-target="" data-placement="left" title="Categories" >' +
                  '<i class="glyphicon glyphicon-plus"></i> <b>Add Category</b></button>';
      ...
      var bindEventHandlers = function() {
          ...
          $('#confirm_delete').click(function() {
              ...
              $.ajax({
                  "dataType": "json",
                  "type": "POST",
                  "url": http + "Categories/transaction/delete",
                  "data": [{
                      name: "category_id",
                      value: u.category_id
                  }]
              ...
              if (validateRequiredFields(f)) {
                  ...
                  if (_txnMode == "new") {
                      ...
                      $.ajax({
                          "dataType": "json",
                          "type": "POST",
                          "url": http + "Categories/transaction/create",
                          "data": _data,
                          "beforeSend": function() {
                      ...
                      $.ajax({
                          "dataType": "json",
                          "type": "POST",
                          "url": http + "Categories/transaction/update",
                          "data": _data,
                          "beforeSend": function() {
                                  // showSpinningProgress(btn);
                              }
