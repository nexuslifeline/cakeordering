  $(document).ready(function() {
      loadItem();
      var _txnMode, ready_cake_id, oSelecteditem;
      ...
      $(document).on('click', '[name="edit_info"]', function() {
          ...
          ready_cake_id = oSelecteditem.find('[name="ready_cake_id"]').val();
          ...
          if (validateRequiredFields(f)) {
              ...
              if (_txnMode == "new") {
                  $.ajax({
                      "dataType": "json",
                      "type": "POST",
                      "url": http + "Ready_cakes/transaction/create",
                      "data": _data,
                      "beforeSend": function() {
                  ...
                  $.ajax({
                      "dataType": "json",
                      "type": "POST",
                      "url": http + "Ready_cakes/transaction/update",
                      "data": _data,
                      "beforeSend": function() {
      ...
      $('#confirm_delete').click(function() {
          ...
          $.ajax({
              "dataType": "json",
              "type": "POST",
              "url": http + "Ready_cakes/transaction/delete",
              "data": [{
                  name: "ready_cake_id",
                  value: ready_cake_id
              }]
  ...
  function createStructure(value) {
      var tags =
          ...
          '<p class="group inner list-group-item-text" name="ready_cake_description">' + value.ready_cake_description +
          '<div class="row">' +
