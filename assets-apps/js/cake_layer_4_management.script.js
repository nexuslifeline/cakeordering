  $(document).ready(function() {
          ...
          if (validateRequiredFields(f)) {
              ...
              if (_txnMode == "new") {
                  $.ajax({
                      "dataType": "json",
                      "type": "POST",
                      "url": http + "Cake_4/transaction/create",
                      "data": _data,
                      "beforeSend": function() {
                  ...
                  $.ajax({
                      "dataType": "json",
                      "type": "POST",
                      "url": http + "Cake_4/transaction/update",
                      "data": _data,
                      "beforeSend": function() {
      ...
      $('#confirm_delete').click(function() {
          ...
          $.ajax({
              "dataType": "json",
              "type": "POST",
              "url": http + "Cake_4/transaction/delete",
              "data": [{
                  name: "cake_id",
                  value: cake_id
              }]
  ...
  function loadItem() {
      ...
      $.ajax({
          dataType: "json",
          type: "POST",
          url: http + 'Cake_4/transaction/list', //call controller class/function to execute
      ...
      $('input[name="file_upload[]"]').change(function(event) {
       ...
       $('input[name="file_upload2[]"]').change(function(event) {
          ...
          $.ajax({
              url: http + 'Cake_4/transaction/upload',
              type: "POST",
              data: data,
              cache: false,
              dataType: 'json',
